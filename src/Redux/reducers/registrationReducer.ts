...
import {
  ...
  ActionTypesRegistration
} from "../actions/registration";


const errors = (state:object = {}, action: ActionTypesRegistration)=>{
  switch (action.type) {
...
const fields = (state:object = {}, action: ActionTypesRegistration) =>{
  switch (action.type) {
...
const isLogged = (state:boolean = false, action: ActionTypesRegistration)=>{
  switch (action.type) {
    case REGISTRATION_SET_LOGGED_IN:
      return true;
    case REGISTRATION_SET_ERRORS:
...
// import { combineReducers } from 'redux';
// import {
//   REGISTRATION_SET_ERRORS, REGISTRATION_SET_FIELD, REGISTRATION_SET_LOGGED_IN, REGISTRATION_CLEAR_FORM,
// } from '../actions/registration';
//
